//
// This file was generated by the Retargetable Decompiler and edited By: Ch4r0nN
...
struct _RTL_CRITICAL_SECTION {
    struct _RTL_CRITICAL_SECTION_DEBUG * crisec0;
    unsigned int crisec1;
    unsigned int crisec2;
    char * crisec3;
    char * crisec4;
    unsigned int crisec5;
};

struct _RTL_CRITICAL_SECTION_DEBUG {
    unsigned short ee0;
    int16_t ee1;
    struct _RTL_CRITICAL_SECTION * ee2;
    struct _LIST_ENTRY ee3;
    int32_t ee4;
    int32_t ee5;
    int32_t ee6;
    int16_t ee7;
...
struct _SERVICE_TABLE_ENTRYA {
    char * entya0;
    void (**entrya1)(unsigned int, char **);
};

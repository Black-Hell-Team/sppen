...
class MathJVM extends MathH {
    ...
    /* renamed from: ln */
    private static final double m59ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m60ln(float f) {

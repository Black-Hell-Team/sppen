...
public class StringsKt__StringsKt extends StringsJVM {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
                ...
                if (step < 0 ? first >= last : first <= last) {
                    while (true) {
                        ...
                        if (t4 == null) {
                            ...
                            return Tuples.m48to(Integer.valueOf(first), t4);
                        }
                    }
                }
            } else {
                ...
                if (step2 < 0 ? first2 >= last2 : first2 <= last2) {
                    while (true) {
                        ...
                        if (t6 == null) {
                            ...
                            return Tuples.m48to(Integer.valueOf(first2), t6);
                        }
                    }
                }
            }
        ...
        return Tuples.m48to(Integer.valueOf(indexOf$default), str);
    }

...
public class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        /* class androidx.appcompat.app.AlertController.View$OnClickListenerC00131 */
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0008R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0008R.styleable.AlertDialog, C0008R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0008R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0008R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0008R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0008R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0008R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0008R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0008R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0008R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0008R.C0010id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0008R.C0010id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0008R.C0010id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0008R.C0010id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0008R.C0010id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0008R.C0010id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0008R.C0010id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0008R.C0010id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0008R.C0010id.textSpacerNoButtons)) == null)) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0008R.C0010id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (!(resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0008R.C0010id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0008R.C0010id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0008R.C0010id.scrollIndicatorDown);
        ...
        if (findViewById != null || findViewById2 != null) {
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
                    /* class androidx.appcompat.app.AlertController.C00142 */
                ...
                this.mScrollView.post(new Runnable() {
                    /* class androidx.appcompat.app.AlertController.RunnableC00153 */
            ...
            if (listView != null) {
                listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                    /* class androidx.appcompat.app.AlertController.C00164 */
                ...
                this.mListView.post(new Runnable() {
                    /* class androidx.appcompat.app.AlertController.RunnableC00175 */
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0008R.C0010id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0008R.C0010id.title_template).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.mWindow.findViewById(C0008R.C0010id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0008R.C0010id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0008R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0008R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0008R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                listAdapter = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00181 */
                ...
                listAdapter = new CursorAdapter(this.mContext, this.mCursor, false) {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00192 */
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00203 */
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00214 */
